                    ...
                    <tr >
                        <td style="vertical-align: top;width: 750px;">
                            ...
                            <table border="0" style="margin-top:30px;margin-left: 15px;width: 750px;font-family: cambria;">
                                <tr>
                                    <td style="text-align: left;font-size: 18px;" colspan="2">This is built on the idea that makes it more efficient and useful.After all,It facilitates to:  </td>
                                </tr>
                        ...
                        <form name="login" action="slogin.php" method="post" onsubmit="return validateForm()">
                            <table class="table_right" border="0">
                                ...
                                <tr>
                                    <td><input type="text" class="text_box" name="name" id="name" /><span id="un" style="visibility: hidden;color: red;">*</span></td>
                                </tr>
                                <tr>
                                    <td class="tdleft" style="padding-top:15px;">Password :</td>
                                </tr>
                                <tr>
                        		    <td><input type="password" class="text_box" name="pass" id="pass"/><span id="up" style="visibility: hidden;color: red;">*</span></td>
                                </tr>
                                <tr>
