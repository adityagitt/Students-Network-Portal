...
$str="insert into login values('$stdid','$naame','$paass','$day','$month','$yer','$gender','$add','$city','$state','$mob','$email','$fullname','$course','$year')";
...
<td class="tdleft">User Name :</td>
                		<td class="tdright"><input type="text" name="name" maxlength="30"/><span id="fn" style="visibility: hidden;color: red;">*</span></td>
                        <td class="tdleft">Password :</td>
                		<td class="tdright"><input type="password" name="pass" maxlength="30"/><span id="ln" style="visibility: hidden;color: red;">*</span></td>
                	</tr>	
                 ...
                 <td class="tdright"><input type="text" name="fullname"/></td><td class="tdright"><input type="hidden" name="id"/>	</tr>
